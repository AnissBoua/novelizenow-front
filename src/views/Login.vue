    ...
    <section class="registerform">
        ...
        <div class="registerform_wrap errors">
            ...
            <div class="registerform_block_btn">
                <input @click="login()" class="btn_primary registerform_submit" type="submit" name="submit" id="submit" value="Login">
            </div>
        </div>
        <div>
            <p>You don't have an account ? <RouterLink to="/register">Sign up here</RouterLink> </p>
        </div>
    </section>
  </template>
